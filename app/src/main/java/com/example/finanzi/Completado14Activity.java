...
public class Completado14Activity extends AppCompatActivity {
    ...
    boolean completado9,completado10,completado11,completado12,completado13,completado14;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado14Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado14Activity.this,Cuestionario15Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
