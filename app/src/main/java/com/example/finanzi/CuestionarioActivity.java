...
public class CuestionarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdOpc2.setText("Es lo que se da o se recibe generalmente por la compra o la venta de artículos, servicios u otras cosas.");
        rdOpc3.setText("Es el porcentaje de los ingresos que la persona no gasta, con el propósito de contar con recursos económicos para un desembolso que podría efectuarse más adelante.");
        ...
        if (rdOpc1.isChecked() == false && rdOpc2.isChecked() == false && rdOpc3.isChecked() == false) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("2. ¿Qué estudian las finanzas?");
                    rdOpc1.setText("Estudia los mercados de dinero, la obtención de recursos, formas de ahorro e inversión.");
                    rdOpc2.setText("Aprender a manejar el dinero.");
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Qué es el dinero?");
                    rdOpc1.setText("Un papel para comprar cositas en el D1");
                    rdOpc2.setText("Es lo que se da o se recibe generalmente por la compra o la venta de artículos, servicios u otras cosas");
                    rdOpc3.setText("Ninguna de las anteriores.");
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Qué es el ahorro?");
                    rdOpc1.setText("Es el porcentaje de los ingresos que la persona no gasta, con el propósito de contar con recursos económicos para un desembolso que podría efectuarse más adelante.");
                    rdOpc2.setText("Es un monto de dinero que se tiene ahorrado por si en algún momento surge un imprevisto o un gasto importante que no se tenía en el presupuesto");
                    rdOpc3.setText("Gestionar la liquidez de la empresa. Administrar deudas. Aumentar el rendimiento de capital");
                    rdOpc1.setChecked(false);
                    rdOpc2.setChecked(false);
                    rdOpc3.setChecked(false);
                    rdOpc1.setBackgroundResource(R.drawable.white);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Con qué animal se puede relacionar el ahorro?");
                    rdOpc1.setText("Cerdo");
                    rdOpc2.setText("Pájaro");
                    rdOpc3.setText("Gato");
                    rdOpc1.setChecked(false);
                    rdOpc2.setChecked(false);
                    rdOpc3.setChecked(false);
    ...
    private void ircompletado1() {
        Intent intent = new Intent(CuestionarioActivity.this,CompletadoActivity.class);
    ...
    public void Salir(View v) {
        Intent intent = new Intent(CuestionarioActivity.this,InicioActivity.class);
        intent.putExtra(LlaveVida,vidas);
        intent.putExtra(LlaveDinero,dinero);
        startActivity(intent);
        finish();
