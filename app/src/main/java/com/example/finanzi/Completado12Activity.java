...
public class Completado12Activity extends AppCompatActivity {
    ...
    boolean completado9,completado10,completado11,completado12;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado12Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado12Activity.this,Cuestionario13Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
