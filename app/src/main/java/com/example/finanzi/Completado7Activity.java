...
public class Completado7Activity extends AppCompatActivity {
    ...
    boolean completado,completado2,completado3,completado4,completado5,completado6,completado7;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado7Activity.this,InicioActivity.class);
