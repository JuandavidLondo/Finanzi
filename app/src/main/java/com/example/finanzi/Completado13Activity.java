...
public class Completado13Activity extends AppCompatActivity {
    ...
    boolean completado9,completado10,completado11,completado12,completado13;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado13Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado13Activity.this,Cuestionario14Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
