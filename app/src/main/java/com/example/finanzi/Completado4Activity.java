...
public class Completado4Activity extends AppCompatActivity {
    ...
    boolean completado,completado2,completado3,completado4;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado4Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado4Activity.this,Cuestionario5Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
