...
public class Completado11Activity extends AppCompatActivity {
    ...
    boolean completado9,completado10,completado11;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado11Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado11Activity.this,Cuestionario12Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
