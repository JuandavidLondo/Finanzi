...
public class Completado9Activity extends AppCompatActivity {
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado9Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado9Activity.this,Cuestionario10Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
