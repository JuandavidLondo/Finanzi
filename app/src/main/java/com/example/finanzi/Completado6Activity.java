...
public class Completado6Activity extends AppCompatActivity {
    ...
    boolean completado,completado2,completado3,completado4,completado5,completado6;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado6Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado6Activity.this,Cuestionario7Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
