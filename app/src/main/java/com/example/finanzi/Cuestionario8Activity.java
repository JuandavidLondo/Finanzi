...
public class Cuestionario8Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuestionario8);
        ...
        rdOpc1.setText("Activo, pasivo, patrimonio.");
        rdOpc2.setText("Activo, equilibrado, dinero.");
        rdOpc3.setText("Finanzas, ganancias, plata.");
        ...
        if (rdOpc1.isChecked() == false && rdOpc2.isChecked() == false && rdOpc3.isChecked() == false) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    rdOpc1.setText("Es el reflejo de la contabilidad de una empresa y muestran la estructura económica de ésta.");
                    rdOpc2.setText("Un estado que monta las finanzas.");
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Cuál es el estado de flujos de efectivo?");
                    rdOpc1.setText("De como se maneja el dinero en un día. ");
                    rdOpc2.setText("Muestra las fuentes, regularidad y uso del efectivo de la empresa, usando estimaciones directas (la más utilizada) o indirectas.");
                    rdOpc3.setText("No existe el flujo de efectivo.");
                    rdOpc1.setChecked(false);
                    rdOpc2.setChecked(false);
                    rdOpc3.setChecked(false);
                    grupo.clearCheck();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Qué es un estado de cambios en el patrimonio neto?");
                    rdOpc1.setText("Mostrar variaciones de ingresos.");
                    rdOpc2.setText("Muestra las variaciones en las entradas y salidas en las operaciones de la empresa entre el inicio del período y el final de este, generalmente un año.");
                    rdOpc3.setText("Gastar mas de la cuenta.");
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    rdOpc1.setText("Gastar mas de la cuenta.");
                    rdOpc2.setText("Resultados económicos.");
                    rdOpc3.setText("cuenta de resultados, estado de ganancias y pérdidas o cuenta de pérdidas.");
                    rdOpc1.setChecked(false);
                    rdOpc2.setChecked(false);
                    rdOpc3.setChecked(false);
                    grupo.clearCheck();
    ...
    private void ircompletado8() {
        Intent intent = new Intent(Cuestionario8Activity.this,Completado8Activity.class);
    ...
    public void Salir(View v) {
        Intent intent = new Intent(Cuestionario8Activity.this,InicioActivity.class);
        intent.putExtra(LlaveVida,vidas);
        intent.putExtra(LlaveDinero,dinero);
        startActivity(intent);
        finish();
