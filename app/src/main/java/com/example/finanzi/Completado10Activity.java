...
public class Completado10Activity extends AppCompatActivity {
    ...
    boolean completado9,completado10;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado10Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado10Activity.this,Cuestionario11Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
