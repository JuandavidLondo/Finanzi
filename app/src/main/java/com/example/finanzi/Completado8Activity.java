...
public class Completado8Activity extends AppCompatActivity {
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado8Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado8Activity.this,Cuestionario9Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
