...
public class Completado3Activity extends AppCompatActivity {
    ...
    boolean completado,completado2,completado3;
    ...
    private void irInicio() {
        Intent intent = new Intent(Completado3Activity.this,InicioActivity.class);
    ...
    private void irsiguiente() {
        Intent intent = new Intent(Completado3Activity.this,Cuestionario4Activity.class);
        intent.putExtra(LlaveVida,vida);
        intent.putExtra(LLaveDinero,dinero);
        startActivity(intent);
        finish();
