...
public class Cuestionario14Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPregunta.setText("¿Qué es una transacción?");
        rdOpc1.setText("Perder toda la plata.");
        rdOpc2.setText("Pasar dinero a otra persona.");
        rdOpc3.setText("Aquí se incluyen las órdenes de transferencia de dinero de una cuenta a otra, la aceptación de cheques y las operaciones que se llevan a cabo.");
        ...
        if (rdOpc1.isChecked() == false && rdOpc2.isChecked() == false && rdOpc3.isChecked() == false) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Qué es un préstamo?");
                    rdOpc1.setText("Estos son concedidos a los clientes que requieren financiamiento, y se les permite a los clientes tener líneas de crédito u otros tipos de crédito.");
                    rdOpc2.setText("Dar dinero gratis.");
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Qué es una deuda?");
                    rdOpc1.setText("Ganar mas dinero de lo normal.");
                    rdOpc2.setText("Ganarse la lotería.");
                    rdOpc3.setText("La obligación que tiene una persona de pagar o devolver una cosa, generalmente dinero.");
                    rdOpc1.setChecked(false);
                    rdOpc2.setChecked(false);
                    rdOpc3.setChecked(false);
                    rdOpc1.setBackgroundResource(R.drawable.white);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Cuál es un posible ejemplo de deuda?");
                    rdOpc1.setText("Mas necesidades.");
                    rdOpc2.setText("Realizar un pedido en una tienda e irlo a pagar una semana después.");
                    rdOpc3.setText("Ganar más dinero.");
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Qué es un crédito?");
                    rdOpc1.setText("Cuando te multiplican el sueldo. ");
                    rdOpc2.setText("El crédito es un préstamo de dinero que una parte otorga a otra, con el compromiso de que, en el futuro, quien lo recibe devolverá dicho préstamo en forma gradual.");
                    rdOpc3.setText("No deber dinero.");
                    rdOpc1.setChecked(false);
                    rdOpc2.setChecked(false);
                    rdOpc3.setChecked(false);
                    rdOpc1.setBackgroundResource(R.drawable.white);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    txtPregunta.setText("¿Qué tipos de créditos existen?");
                    rdOpc1.setText("Crédito comercial, crédito de consumo, microcréditos, crédito garantiza, crédito personal, crédito hipotecario, crédito rotativo.");
                    rdOpc2.setText("No existen tipos de créditos.");
                    rdOpc3.setText("Crédito de deudas, créditos personales, crédito empresarial.");
                    rdOpc1.setChecked(false);
                    rdOpc2.setChecked(false);
                    rdOpc3.setChecked(false);
                    rdOpc1.setBackgroundResource(R.drawable.white);
    ...
    private void ircompletado14() {
        Intent intent = new Intent(Cuestionario14Activity.this,Completado14Activity.class);
    ...
    public void Salir(View v) {
        Intent intent = new Intent(Cuestionario14Activity.this,InicioActivity.class);
        intent.putExtra(LlaveVida,vidas);
        intent.putExtra(LlaveDinero,dinero);
        startActivity(intent);
        finish();
